Migrating a Wordpress theme to a new host shouldn't be a pain in the ass, that's why I created this library to help myself and everyone who needs to migrate a wordpress in seconds without any issues.
